...
| --- | --- |
| `bmad-product-brief` | Tạo hoặc cập nhật product brief — phiên discovery có hướng dẫn khi concept của bạn đã rõ |
...
| `bmad-prd` | Tạo, cập nhật, hoặc xác thực Product Requirements Document |
| `bmad-ux` | Thiết kế trải nghiệm người dùng |
